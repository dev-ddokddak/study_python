...
class Bank:
    # 은행별 사용자 정보를 담는 2차원배열 리스트를 선언한다.
    total_count = 3
    ...
    def open_account(cls, owner: str, account_number: str, phone: str, password: str, money: int, bank_choice: int):
        ...
        # ][bank_choice - 1]
        bank_type = [ShinHan, KookMin, KaKao]
        bank = bank_type[bank_choice-1](owner, account_number, phone, password, money)
...
if __name__ == '__main__':
    ...
    error_bank_message = "계좌 개설한 은행에서 입금해주세요"
        ...
        while True:
            ...
            # 입금
                ...
                if user is not None:
                    ...
                    if type(user["object"]) == bank_names[bank_choice - 1]:
